...
program.version('0.1.0')
    .description('A utility to generate YUI modules and tests.')
        ...
        .option('-B, --no-builder', 'Do not follow YUI Builder pattern (/my-module/my-module.js)')
        .option('-p, --prefix [string]', 'Prefix dash-prepended to module name. If empty, defaults to namespace, if provided.', '@NAMESPACE@')
        .option('-M, --no-module-prefix', 'Do not default to namespace for prefix')
...
if (module === require.main) {
    ...
    var assert = require('assert'),
        ...
        tests = [
            ...
            ['my-plugin -t plugin -n Z.Plugin -p z', {
                cmd: 'module',
                dirName : 'my-plugin',
                fileName: 'my-plugin',
                template: 'plugin',
            ...
            ['prefix-my-namespace -n Z', {
                cmd: 'module',
                dirName : 'prefix-my-namespace',
                fileName: 'prefix-my-namespace',
                template: 'base',
                rootPath: rootPathDefault,
                prefix: 'z',
                modulePrefix: true,
            ...
            ['prefix-nothing -n Z -M', {
                cmd: 'module',
                dirName : 'prefix-nothing',
                fileName: 'prefix-nothing',
                template: 'base',
                rootPath: rootPathDefault,
                prefix: 'z',
                modulePrefix: false,
            ...
            ['no-builder-file no-builder-dir -B', {
                cmd: 'module',
                dirName : 'no-builder-dir',
                fileName: 'no-builder-file',
                template: 'base',
                // prefix: 'z',
                // modulePrefix: false,
                namespace: '',
